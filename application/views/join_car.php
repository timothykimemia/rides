              ...
              <div class="col-md-6 form-group">
                <div></div>
					...
					<div class="datakendaraan">
						<h1 style="font-weight:bold;font-size: 35px;letter-spacing: 2px;">Transportation Detail</h1>
						<hr>
						<div class="row">
							<div class="col-md-6 form-group">
								<label>Transportation Type</label>
								<input type="text" placeholder="Transportation Type" class="form-control" name="merk">
							</div>
							...
							<div class="col-md-12">
							   <div class="col-md-12 form-group" style=" margin-left:-25px;width:100%;">
