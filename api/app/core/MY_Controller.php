...
//        $this->data['page_title'] = 'Obah';
//        $this->data['page_description'] = 'Obah';
...
//        }
//        $this->data['page_title'] = 'Obah - Administrator';
    }
...
//        $this->data['current_user'] = $current_user;
//        $this->data['current_user_menu'] = '';
//        if ($this->ion_auth->in_group('restaurant')) {
//            $this->data['current_user_menu'] = $this->load->view('templates/_parts/user_menu_admin_view.php', NULL, TRUE);
//        }
//        $this->data['page_title'] = 'Obah - Restaurant';
    }

//    protected function render($the_view = NULL, $template = 'restaurant_master') {
//        parent::render($the_view, $template);
//    }
