...
//        
        ...
        $request = $this->Book_model->insert_transaksi_mfood($data_req, $data_detail, $dec_data->messagean);
        if($request['status']){
            $message = array(
                'message' => 'success',
                'data' => $request['data']
...
//        
        ...
        $request = $this->Book_model->insert_transaksi_mstore($data_req, $data_detail, $dec_data->messagean);
        if($request['status']){
            $message = array(
                'message' => 'success',
                'data' => $request['data']
...
//        
        ...
        $request = $this->Book_model->insert_transaksi_mmart($data_req, $data_detail, $dec_data->messagean);
        if($request['status']){
            $message = array(
                'message' => 'success',
                'data' => $request['data']
