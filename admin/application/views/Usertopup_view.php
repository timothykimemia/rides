...
//                                                        }
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url();?>index.php/usertopup/validationTopupForm/<?php echo $key->nomor;?>/<?php echo $key->id_user;?>"><button type="button" class="btn btn-primary btn-sm">Verification</button></a>
                                                        <a href="<?php echo base_url();?>index.php/usertopup/batalTopup/<?php echo $key->nomor;?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to cancel the transaction ?')">Delete</button></a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
