                                                    ...
                                                    <div class="modal-content">
                                                        <form method="POST" action="<?php echo base_url(); ?>index.php/Manualtransaction/penambahanPelanggan">
                                                            <div class="modal-header">
                                                               <h4 class="modal-title" id="myModalLabel">Add Ballance <?php echo "$d->nama_depan $d->nama_belakang"; ?></h4>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <form method="POST" action="<?php echo base_url(); ?>index.php/Manualtransaction/penguranganPelanggan">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="myModalLabel">Balance Reduction &nbsp;&nbsp;<?php echo "$d->nama_depan $d->nama_belakang"; ?></h4>
																<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
