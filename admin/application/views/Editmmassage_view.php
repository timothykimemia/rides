...
<html>
    <head>
        ...
        <title>Go Ride Me - Edit Mmassage</title>
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="status" class="form-control" id="sel1">
                                                            ...
                                                            <option value="2">Nonaktive</option>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <img src="<?php echo base_url() . "/fotommassage/" . $driver[0]['foto'] ?>" class="col-md-12 img-responsive img-thumbnail" alt="Cinque Terre">
