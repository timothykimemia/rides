        ...
        <div class="content-wrapper">
              ...
              <div class="card">
				...
				<div class="box-header with-border">
                  <div class="box-body">
                                    <div class="col-md-12">
                                        <h3 class="text-center"> Edit Massage</h3>
                                        <form action="<?php echo base_url(); ?>index.php/Layananpijat/updateLayananPijat" method="POST" role="form" enctype="multipart/form-data">
                                            ...
                                            <img src="<?php echo base_url() . "/foto_pijat/" . $layanan[0]['foto']; ?>" class="img-responsive img-thumbnail col-md-12" alt="Cinque Terre"><br>
